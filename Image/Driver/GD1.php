...
require_once PHOTOUPLOAD_PATH.'Image/Transform/Driver/GD.php';
 ...
 * @version $Id: GD1.php 2 2010-01-23 20:02:06Z hthouzard $
 * @access public
 **/
    ...
    function rotate($angle, $options = null)
    {
        ...
        if (!is_array($color_mask)) {
            ...
            if ($color_mask{0} == '#'){
                ...
                include_once PHOTOUPLOAD_PATH.'Image/Transform/Driver/ColorsDefs.php';
