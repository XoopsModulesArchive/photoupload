 ...
 * @version    CVS: $Id: IM.php 2 2010-01-23 20:02:06Z hthouzard $
 * @link       http://pear.php.net/package/Image_Transform
 */

require_once PHOTOUPLOAD_PATH.'Image/Transform.php';
require_once PHOTOUPLOAD_PATH.'Image/System.php';
...
class Image_Transform_Driver_IM extends Image_Transform
{
    ...
    function __construct()
    {
        ...
        if (System::which(IMAGE_TRANSFORM_IM_PATH . 'convert' . ((OS_WINDOWS) ? '.exe' : ''))) {
            include PHOTOUPLOAD_PATH.'Image/Transform/Driver/Imagick/ImageTypes.php';
        } else {
