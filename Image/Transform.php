 ...
 * @version    CVS: $Id: Transform.php 2 2010-01-23 20:02:06Z hthouzard $
 ...
 */
require_once PHOTOUPLOAD_PATH.'Image/PEAR.php';
...
class Image_Transform
{
    ...
    function &factory($driver = '')
    {
        ...
        @require_once PHOTOUPLOAD_PATH.'Image/Driver/' . basename($driver) . '.php';
    ...
    function getTempDir()
    {
        include_once PHOTOUPLOAD_PATH.'Image/System.php';
