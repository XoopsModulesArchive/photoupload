...
class photoupload_utils
{

	const MODULE_NAME = 'photoupload';
	...
	function &getInstance()
	{
		static $instance;
		if (!isset($instance)) {
			$instance = new photoupload_utils();
		}
		return $instance;
	}
	...
	protected function _getModule()
	{
		...
		if (!isset($mymodule)) {
			global $xoopsModule;
			if (isset($xoopsModule) && is_object($xoopsModule) && $xoopsModule->getVar('dirname') == PHOTOUPLOAD_DIRNAME ) {
				$mymodule =& $xoopsModule;
			} else {
				$hModule = &xoops_gethandler('module');
				$mymodule = $hModule->getByDirname(PHOTOUPLOAD_DIRNAME);
			}
		}
		return $mymodule;
	}
	...
	{
	    require_once PHOTOUPLOAD_PATH.'class/wideimage/WideImage.inc.php';
	...
	function getMimeType($filename)
	{
	   	if(function_exists('finfo_open')) {
   			$pathToMagic = PHOTOUPLOAD_PATH.'mime/magic';
